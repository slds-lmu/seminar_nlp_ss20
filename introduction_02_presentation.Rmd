...
```{r figure01a, echo=FALSE, out.width="70%", fig.cap="Traditional ML vs. Transfer Learning", fig.align="center"}
...
```{r figure02, echo=FALSE, out.width="100%", fig.cap="Global attention model, Loung et al. 2015", fig.align="center"}
...
```{r figure08, echo=FALSE, out.width="90%", fig.cap=" Illustration of a CNN for sentence calssification, Source: Zhang, Y., & Wallace, B. (2015). A Sensitivity Analysis of (and Practitioners’ Guide to) Convolutional Neural Networks for Sentence Classification.", fig.align="center"}
knitr::include_graphics("figures/02-00-transfer-learning-for-nlp/nlp-cnn.png")
```
</div>
...
## (Self-)attention
```{r figure07, echo=FALSE, out.width="60%", fig.cap="transformer gif", fig.align="center"}
...
```{r figure012, echo=FALSE, out.width="70%", fig.cap="BERT-4-Tasks", fig.align="center"}
knitr::include_graphics("figures/02-00-transfer-learning-for-nlp/bert-based_model.png")
```

## XLNet permutation language model

```{r figure013, echo=FALSE, out.width="70%", fig.cap="XLNet Permutation language model", fig.align= "center" }
