...
```{r figure_extra7, echo=FALSE, out.width="70%", fig.cap="Retrieved from Universal Language Model Fine-tuning for Text Classification by Howard and Ruder (https://arxiv.org/pdf/1801.06146.pdf)" }
knitr::include_graphics("figures/02-00-transfer-learning-for-nlp/ulmfit.png")
```


## ULMFiT

```{r figure_extra8, echo=FALSE, out.width="70%", fig.cap="Retrieved from https://www.slideshare.net/shuntaroy/a-review-of-deep-contextualized-word-representations-peters-2018"  }
knitr::include_graphics("figures/02-00-transfer-learning-for-nlp/elmo_shuntaroy.png")
```
