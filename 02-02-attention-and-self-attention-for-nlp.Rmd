...
because the attention is spread thinnly/weakly/softly over the input and does not have an inherent hard focus on specific inputs.
...
```{r self-attention-inputs, echo = FALSE, fig.align='center', fig.cap= "Input transformation used in a Transformer, $Q = \text{Query}$, $K = \text{Key}$, $V = \text{Value}$. Image Source: (ref:alammar2018transformer)", out.width="50%"}
...
These attention mechanisms allow Transformers to learn different and distant dependencies in langauge
