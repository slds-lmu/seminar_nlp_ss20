...
```{r echo=FALSE, message=FALSE, fig.align="center",fig.cap="Unfolded computatinal graph of a RNN.", out.width = '100%'}
...
```{r echo=FALSE, message=FALSE, fig.align="center",fig.cap="Structure of a hidden unit. Right: LSTM. Left: GRU. Ispired by http://colah.github.io/posts/2015-08-Understanding-LSTMs/", out.width = '100%'}
