...
## Most popular models
In the following sections, the models **ELMo**, **ULMFiT**, and **GPT** are presented, which shaped the "first wave" of transfer learning before transformers like BERT developed and became popular. 
