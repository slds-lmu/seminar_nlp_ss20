...
In second step, follows the **adoption** on the target task. Here, the main distinction is that the pre-trained model weights are kept (**embedding** or **feature extraction**) or the pre-trained weights are adjusted to the target task (**fine-tuning**) [@peterrudersmith2019].
...
* Starting with 12 layers in GPT, the models get deeper and use more parameters and data for the pre-training. 
