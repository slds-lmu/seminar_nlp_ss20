...
One good example for polysemy is the word "mouse". In an technical context it means the computer mouse and other contexts it could mean the rodent. Previous models can just capture the semantical and syntactical characteristics of the word, ELMo can also capture the varying meaning of the word in the different contexts (here: computer mouse or rodent). 

ELMo can be divided into the steps of pretraining and adoption:
...
It is pretrained on the 1 Billion Word Benchmark, a standard dataset for language modeling from Google. Elmo's model architecture is a shallowly bidirectional Language model, which will be explained in the other sections. 
