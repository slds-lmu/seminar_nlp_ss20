...
```{r 02-transformer, echo=FALSE, out.width="60%", fig.cap="Transformer architecture for tensor2tensor. The encoder (left) and the decoder (right) are composed of N=6 identical layers. The decoder is connected to the encoder with a multi-head-attention sublayer. Figure 1 from [@vaswani2017attention]"}
